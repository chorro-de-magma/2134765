...
async function fetchResults(query) {
  ...
  if (window.glob.isStatic) {
    if (!fuseInstance) {
      ...
      const Fuse = (await import("./fuse-RAGRSGLF.js")).default;
...
async function setupMermaid() {
  ...
  const mermaid = (await import("./mermaid.core-EZEDOSQ2.js")).default;
...
async function setupMath() {
  ...
  const renderMathInElement = (await import("./auto-render-QQTAH2OE.js")).default;
  await import("./mhchem-OD675UAP.js");
