import {
  ...
  markers_default,
  positionEdgeLabel
} from "./chunk-XCYIHSM3.js";
import {
  insertCluster,
  insertNode,
  labelHelper
} from "./chunk-MAPMSBQM.js";
import {
  interpolateToCurve
...
var registerDefaultLayoutLoaders = /* @__PURE__ */ __name(() => {
  registerLayoutLoaders([
    {
      name: "dagre",
      loader: /* @__PURE__ */ __name(async () => await import("./dagre-BM42HDAG-LTL23PSI.js"), "loader")
    },
    ...true ? [
      {
        name: "cose-bilkent",
        loader: /* @__PURE__ */ __name(async () => await import("./cose-bilkent-S5V4N54A-LO3OGW3Z.js"), "loader")
      }
    ] : []
  ]);
